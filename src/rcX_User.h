...
*******************************************************************************
  ...
  Last Modification:
    @version $Id: rcX_User.h 362 2010-05-04 12:56:53Z Volker $
  ...
  ---------------------------------------------------------------------------
    2010-05-04  NC            Added "System Status" defines
...
#define NETX_STATUS_BLOCK_VERSION 1 /*!< version of the common status block structure */
...
typedef __RCX_PACKED_PRE struct NETX_SYSTEM_STATUS_BLOCKtag
{
  ...
  uint32_t ulReserved1; /*!< 0x0C reserved */
...
/*****************************************************************************/
/*! Structure the default communication channel (Size 15616 Byte)            */
/*****************************************************************************/
...
#define HSF_BOOTSTART \
  0x0002 /*!< Set when device has a second stage loader, to enter bootloader mode after a system start */
...
#define HSF_BOOTLOADER_BIT_NO \
  1 /*!< Bitnumber to be set when device has a second stage loader, to enter bootloader mode after a system start */
...
#define RCX_HW_DEV_CLASS_COMX 0x0004
...
#define RCX_HW_DEV_CLASS_NETIC 0x0013
...
#define RCX_IO_MODE_UNKNOWN 0x0000 /*!< I/O mode unkown transfer */
...
#define RCX_MAX_PACKET_SIZE 1600 /*!< Maximum size of the RCX packet in bytes */
